...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_width_out1 \
    op interface \
    ports { width_out1_din { O 32 vector } width_out1_full_n { I 1 bit } width_out1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_height_out2 \
    op interface \
    ports { height_out2_din { O 32 vector } height_out2_full_n { I 1 bit } height_out2_write { O 1 bit } } \
} "
}
