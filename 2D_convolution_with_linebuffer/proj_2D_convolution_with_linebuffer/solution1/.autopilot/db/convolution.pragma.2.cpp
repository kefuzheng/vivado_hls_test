...
{
_ssdm_op_SpecInterface(src, "ap_bus", 0, 0, "", 0, 32400, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecResource(src, "", "AXI4M", "", -1, "", "", "", "", "");
_ssdm_op_SpecInterface(dst, "ap_bus", 0, 0, "", 0, 32400, "", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecResource(dst, "", "AXI4M", "", -1, "", "", "", "", "");
_ssdm_op_SpecResource(0, "", "AXI4LiteS", "", -1, "", "", "", "", "-bus_bundle hls_ctrl");
_ssdm_op_SpecResource(width, "", "AXI4LiteS", "", -1, "", "", "", "", "-bus_bundle hls_ctrl");
_ssdm_op_SpecResource(height, "", "AXI4LiteS", "", -1, "", "", "", "", "-bus_bundle hls_ctrl");
