...
architecture behav of filter11x11_strm is 
    ...
    "filter11x11_strm,hls_ip_2019_1_0,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=6.660000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.061000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=44,HLS_SYN_DSP=48,HLS_SYN_FF=8188,HLS_SYN_LUT=4714,HLS_VERSION=2019_1_0}";
    ...
    signal Loop_HConvH_proc8_U0_start_out : STD_LOGIC;
    signal Loop_HConvH_proc8_U0_start_write : STD_LOGIC;
    signal Loop_HConvH_proc8_U0_height_read : STD_LOGIC;
    signal Loop_HConvH_proc8_U0_width_read : STD_LOGIC;
    signal Loop_HConvH_proc8_U0_src_V_TREADY : STD_LOGIC;
    signal Loop_HConvH_proc8_U0_hconv_V_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Loop_HConvH_proc8_U0_hconv_V_write : STD_LOGIC;
    ...
    signal ap_sync_reg_Loop_HConvH_proc8_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Loop_HConvH_proc8_U0_ap_ready : STD_LOGIC;
    signal Loop_HConvH_proc8_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    component Loop_HConvH_proc8 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    Loop_HConvH_proc8_U0 : component Loop_HConvH_proc8
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ...
        start_out => Loop_HConvH_proc8_U0_start_out,
        start_write => Loop_HConvH_proc8_U0_start_write,
        height_dout => height_c164_dout,
        height_empty_n => height_c164_empty_n,
        height_read => Loop_HConvH_proc8_U0_height_read,
        width_dout => width_c163_dout,
        width_empty_n => width_c163_empty_n,
        width_read => Loop_HConvH_proc8_U0_width_read,
        src_V_TDATA => src_V_TDATA,
        src_V_TVALID => src_V_TVALID,
        src_V_TREADY => Loop_HConvH_proc8_U0_src_V_TREADY,
        hconv_V_din => Loop_HConvH_proc8_U0_hconv_V_din,
        hconv_V_full_n => hconv_V_full_n,
        hconv_V_write => Loop_HConvH_proc8_U0_hconv_V_write);
    ...
    port map (
        ...
        if_read => Loop_HConvH_proc8_U0_width_read);
    ...
    port map (
        ...
        if_read => Loop_HConvH_proc8_U0_height_read);
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Loop_HConvH_proc8_U0_hconv_V_din,
        if_full_n => hconv_V_full_n,
        if_write => Loop_HConvH_proc8_U0_hconv_V_write,
    ...
    port map (
        ...
        if_write => Loop_HConvH_proc8_U0_start_write,
    ...
    ap_sync_reg_Loop_HConvH_proc8_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ...
                    ap_sync_reg_Loop_HConvH_proc8_U0_ap_ready <= ap_sync_Loop_HConvH_proc8_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    Loop_HConvH_proc8_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = Loop_HConvH_proc8_U0_ap_ready) and (ap_sync_ready = ap_const_logic_1))) then 
                Loop_HConvH_proc8_U0_ap_ready_count <= std_logic_vector(unsigned(Loop_HConvH_proc8_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = Loop_HConvH_proc8_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                Loop_HConvH_proc8_U0_ap_ready_count <= std_logic_vector(unsigned(Loop_HConvH_proc8_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Loop_HConvH_proc8_U0_ap_start <= ((ap_sync_reg_Loop_HConvH_proc8_U0_ap_ready xor ap_const_logic_1) and ap_start);
    ...
    ap_done <= Loop_Border_proc_U0_ap_done;
    ap_idle <= (filter11x11_strm_ent_U0_ap_idle and Loop_VConvH_proc_U0_ap_idle and Loop_HConvH_proc8_U0_ap_idle and Loop_Border_proc_U0_ap_idle and Block_proc_U0_ap_idle);
    ...
    ap_sync_Loop_HConvH_proc8_U0_ap_ready <= (ap_sync_reg_Loop_HConvH_proc8_U0_ap_ready or Loop_HConvH_proc8_U0_ap_ready);
    ...
    ap_sync_ready <= (ap_sync_filter11x11_strm_ent_U0_ap_ready and ap_sync_Loop_HConvH_proc8_U0_ap_ready);
    dst_V_TDATA <= Loop_Border_proc_U0_dst_V_TDATA;
    dst_V_TVALID <= Loop_Border_proc_U0_dst_V_TVALID;
