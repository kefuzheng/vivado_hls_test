...
Loop_Border_proc::Loop_Border_proc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    filter11x11_strm_mul_32ns_32ns_64_3_1_U42 = new filter11x11_strm_mul_32ns_32ns_64_3_1<1,3,32,32,64>("filter11x11_strm_mul_32ns_32ns_64_3_1_U42");
    filter11x11_strm_mul_32ns_32ns_64_3_1_U42->clk(ap_clk);
    filter11x11_strm_mul_32ns_32ns_64_3_1_U42->reset(ap_rst);
    filter11x11_strm_mul_32ns_32ns_64_3_1_U42->din0(grp_fu_187_p0);
    filter11x11_strm_mul_32ns_32ns_64_3_1_U42->din1(grp_fu_187_p1);
    filter11x11_strm_mul_32ns_32ns_64_3_1_U42->ce(ap_var_for_const0);
    filter11x11_strm_mul_32ns_32ns_64_3_1_U42->dout(grp_fu_187_p2);

    SC_METHOD(thread_ap_clk_no_reset_);
    dont_initialize();
    sensitive << ( ap_clk.pos() );

    SC_METHOD(thread_add_ln203_1_fu_261_p2);
    sensitive << ( i6_0_i_i_i_reg_159 );

    SC_METHOD(thread_add_ln203_fu_255_p2);
    sensitive << ( indvar_flatten_reg_148 );

    SC_METHOD(thread_add_ln207_fu_203_p2);
    sensitive << ( height_read_reg_474 );

    SC_METHOD(thread_add_ln217_fu_193_p2);
    sensitive << ( width_read_reg_466 );

    SC_METHOD(thread_add_ln224_fu_198_p2);
    sensitive << ( width_read_reg_466 );

    SC_METHOD(thread_add_ln227_fu_397_p2);
    sensitive << ( select_ln203_reg_525_pp0_iter1_reg );

    SC_METHOD(thread_and_ln207_1_fu_296_p2);
    sensitive << ( icmp_ln207_5_fu_291_p2 );
    sensitive << ( icmp_ln207_4_fu_285_p2 );

    SC_METHOD(thread_and_ln207_fu_229_p2);
    sensitive << ( icmp_ln207_2_fu_224_p2 );
    sensitive << ( icmp_ln207_1_fu_218_p2 );

    SC_METHOD(thread_and_ln224_fu_424_p2);
    sensitive << ( icmp_ln224_reg_551_pp0_iter2_reg );
    sensitive << ( xor_ln222_fu_418_p2 );
    ...
    sensitive << ( select_ln203_1_reg_533 );
    sensitive << ( icmp_ln210_reg_542 );
    ...
    sensitive << ( ap_enable_reg_pp0_iter2 );
    sensitive << ( zext_ln212_fu_354_p1 );

    SC_METHOD(thread_borderbuf_address1);
    sensitive << ( ap_block_pp0_stage0 );
    sensitive << ( ap_enable_reg_pp0_iter2 );
    sensitive << ( zext_ln227_fu_402_p1 );
    ...
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( select_ln203_1_reg_533_pp0_iter1_reg );
    sensitive << ( icmp_ln210_reg_542_pp0_iter1_reg );
    sensitive << ( ap_enable_reg_pp0_iter2 );
    ...
    SC_METHOD(thread_icmp_ln203_fu_250_p2);
    ...
    SC_METHOD(thread_icmp_ln204_fu_245_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( width_read_reg_466 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( zext_ln204_fu_241_p1 );

    SC_METHOD(thread_icmp_ln207_1_fu_218_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( i6_0_i_i_i_reg_159 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );

    SC_METHOD(thread_icmp_ln207_2_fu_224_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( add_ln207_reg_505 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( zext_ln203_1_fu_208_p1 );

    SC_METHOD(thread_icmp_ln207_3_fu_279_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( icmp_ln203_fu_250_p2 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( add_ln203_1_fu_261_p2 );

    SC_METHOD(thread_icmp_ln207_4_fu_285_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( icmp_ln203_fu_250_p2 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    ...
    SC_METHOD(thread_icmp_ln207_5_fu_291_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( add_ln207_reg_505 );
    sensitive << ( icmp_ln203_fu_250_p2 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    ...
    SC_METHOD(thread_icmp_ln207_fu_212_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( i6_0_i_i_i_reg_159 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );

    SC_METHOD(thread_icmp_ln210_fu_328_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( vconv_xlim_loc_read_reg_480 );
    sensitive << ( icmp_ln203_fu_250_p2 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( select_ln203_1_fu_308_p3 );
    sensitive << ( zext_ln203_2_fu_316_p1 );
    ...
    SC_METHOD(thread_icmp_ln217_fu_333_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( add_ln217_reg_495 );
    sensitive << ( icmp_ln203_fu_250_p2 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( select_ln203_1_fu_308_p3 );
    ...
    SC_METHOD(thread_icmp_ln222_fu_413_p2);
    sensitive << ( ap_enable_reg_pp0_iter3 );
    sensitive << ( icmp_ln203_reg_516_pp0_iter2_reg );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( select_ln203_reg_525_pp0_iter2_reg );

    SC_METHOD(thread_icmp_ln224_fu_338_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( add_ln224_reg_500 );
    sensitive << ( icmp_ln203_fu_250_p2 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( zext_ln203_2_fu_316_p1 );
    ...
    sensitive << ( select_ln203_fu_271_p3 );

    SC_METHOD(thread_l_edge_pix_fu_380_p3);
    sensitive << ( icmp_ln217_reg_546_pp0_iter1_reg );
    sensitive << ( r_edge_pix_fu_78 );
    sensitive << ( pix_out_fu_82 );

    SC_METHOD(thread_or_ln207_1_fu_302_p2);
    sensitive << ( icmp_ln207_3_fu_279_p2 );
    sensitive << ( and_ln207_1_fu_296_p2 );

    SC_METHOD(thread_or_ln207_fu_235_p2);
    sensitive << ( icmp_ln207_fu_212_p2 );
    sensitive << ( and_ln207_fu_229_p2 );

    SC_METHOD(thread_pix_out_10_fu_437_p3);
    sensitive << ( pix_out_1_fu_86 );
    sensitive << ( icmp_ln222_fu_413_p2 );
    sensitive << ( pix_out_8_fu_429_p3 );

    SC_METHOD(thread_pix_out_8_fu_429_p3);
    sensitive << ( borderbuf_q1 );
    sensitive << ( pix_out_fu_82 );
    sensitive << ( and_ln224_fu_424_p2 );

    SC_METHOD(thread_select_ln203_1_fu_308_p3);
    sensitive << ( icmp_ln204_fu_245_p2 );
    sensitive << ( or_ln207_fu_235_p2 );
    sensitive << ( or_ln207_1_fu_302_p2 );

    SC_METHOD(thread_select_ln203_2_fu_320_p3);
    sensitive << ( i6_0_i_i_i_reg_159 );
    sensitive << ( add_ln203_1_fu_261_p2 );
    sensitive << ( icmp_ln204_fu_245_p2 );

    SC_METHOD(thread_select_ln203_fu_271_p3);
    sensitive << ( j_0_i_i_i_reg_170 );
    sensitive << ( icmp_ln204_fu_245_p2 );

    SC_METHOD(thread_select_ln214_fu_372_p3);
    sensitive << ( r_edge_pix_fu_78 );
    sensitive << ( pix_out_1_fu_86 );
    ...
    SC_METHOD(thread_xor_ln222_fu_418_p2);
    sensitive << ( icmp_ln222_fu_413_p2 );

    SC_METHOD(thread_zext_ln203_1_fu_208_p1);
    sensitive << ( i6_0_i_i_i_reg_159 );

    SC_METHOD(thread_zext_ln203_2_fu_316_p1);
    sensitive << ( select_ln203_fu_271_p3 );

    SC_METHOD(thread_zext_ln203_fu_267_p1);
    sensitive << ( add_ln203_1_fu_261_p2 );

    SC_METHOD(thread_zext_ln204_fu_241_p1);
    sensitive << ( j_0_i_i_i_reg_170 );

    SC_METHOD(thread_zext_ln212_fu_354_p1);
    sensitive << ( select_ln203_reg_525_pp0_iter1_reg );

    SC_METHOD(thread_zext_ln227_fu_402_p1);
    sensitive << ( add_ln227_fu_397_p2 );
    ...
    sc_trace(mVcdFile, icmp_ln203_reg_516, "icmp_ln203_reg_516");
    sc_trace(mVcdFile, icmp_ln203_reg_516_pp0_iter2_reg, "icmp_ln203_reg_516_pp0_iter2_reg");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter4, "ap_enable_reg_pp0_iter4");
    sc_trace(mVcdFile, icmp_ln203_reg_516_pp0_iter3_reg, "icmp_ln203_reg_516_pp0_iter3_reg");
    ...
    sc_trace(mVcdFile, select_ln203_1_reg_533, "select_ln203_1_reg_533");
    sc_trace(mVcdFile, icmp_ln210_reg_542, "icmp_ln210_reg_542");
    ...
    sc_trace(mVcdFile, add_ln217_fu_193_p2, "add_ln217_fu_193_p2");
    sc_trace(mVcdFile, add_ln217_reg_495, "add_ln217_reg_495");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, add_ln224_fu_198_p2, "add_ln224_fu_198_p2");
    sc_trace(mVcdFile, add_ln224_reg_500, "add_ln224_reg_500");
    sc_trace(mVcdFile, add_ln207_fu_203_p2, "add_ln207_fu_203_p2");
    sc_trace(mVcdFile, add_ln207_reg_505, "add_ln207_reg_505");
    sc_trace(mVcdFile, grp_fu_187_p2, "grp_fu_187_p2");
    sc_trace(mVcdFile, bound_reg_511, "bound_reg_511");
    sc_trace(mVcdFile, icmp_ln203_fu_250_p2, "icmp_ln203_fu_250_p2");
    ...
    sc_trace(mVcdFile, icmp_ln203_reg_516_pp0_iter1_reg, "icmp_ln203_reg_516_pp0_iter1_reg");
    sc_trace(mVcdFile, add_ln203_fu_255_p2, "add_ln203_fu_255_p2");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter0, "ap_enable_reg_pp0_iter0");
    sc_trace(mVcdFile, select_ln203_fu_271_p3, "select_ln203_fu_271_p3");
    sc_trace(mVcdFile, select_ln203_reg_525, "select_ln203_reg_525");
    sc_trace(mVcdFile, select_ln203_reg_525_pp0_iter1_reg, "select_ln203_reg_525_pp0_iter1_reg");
    sc_trace(mVcdFile, select_ln203_reg_525_pp0_iter2_reg, "select_ln203_reg_525_pp0_iter2_reg");
    sc_trace(mVcdFile, select_ln203_1_fu_308_p3, "select_ln203_1_fu_308_p3");
    sc_trace(mVcdFile, select_ln203_1_reg_533_pp0_iter1_reg, "select_ln203_1_reg_533_pp0_iter1_reg");
    sc_trace(mVcdFile, select_ln203_2_fu_320_p3, "select_ln203_2_fu_320_p3");
    sc_trace(mVcdFile, icmp_ln210_fu_328_p2, "icmp_ln210_fu_328_p2");
    sc_trace(mVcdFile, icmp_ln210_reg_542_pp0_iter1_reg, "icmp_ln210_reg_542_pp0_iter1_reg");
    sc_trace(mVcdFile, icmp_ln217_fu_333_p2, "icmp_ln217_fu_333_p2");
    sc_trace(mVcdFile, icmp_ln217_reg_546, "icmp_ln217_reg_546");
    sc_trace(mVcdFile, icmp_ln217_reg_546_pp0_iter1_reg, "icmp_ln217_reg_546_pp0_iter1_reg");
    sc_trace(mVcdFile, icmp_ln224_fu_338_p2, "icmp_ln224_fu_338_p2");
    sc_trace(mVcdFile, icmp_ln224_reg_551, "icmp_ln224_reg_551");
    sc_trace(mVcdFile, icmp_ln224_reg_551_pp0_iter1_reg, "icmp_ln224_reg_551_pp0_iter1_reg");
    sc_trace(mVcdFile, icmp_ln224_reg_551_pp0_iter2_reg, "icmp_ln224_reg_551_pp0_iter2_reg");
    ...
    sc_trace(mVcdFile, zext_ln212_fu_354_p1, "zext_ln212_fu_354_p1");
    sc_trace(mVcdFile, zext_ln227_fu_402_p1, "zext_ln227_fu_402_p1");
    ...
    sc_trace(mVcdFile, select_ln214_fu_372_p3, "select_ln214_fu_372_p3");
    sc_trace(mVcdFile, ap_block_pp0_stage0_01001, "ap_block_pp0_stage0_01001");
    sc_trace(mVcdFile, grp_fu_187_p0, "grp_fu_187_p0");
    sc_trace(mVcdFile, grp_fu_187_p1, "grp_fu_187_p1");
    sc_trace(mVcdFile, zext_ln203_1_fu_208_p1, "zext_ln203_1_fu_208_p1");
    sc_trace(mVcdFile, icmp_ln207_2_fu_224_p2, "icmp_ln207_2_fu_224_p2");
    sc_trace(mVcdFile, icmp_ln207_1_fu_218_p2, "icmp_ln207_1_fu_218_p2");
    sc_trace(mVcdFile, icmp_ln207_fu_212_p2, "icmp_ln207_fu_212_p2");
    sc_trace(mVcdFile, and_ln207_fu_229_p2, "and_ln207_fu_229_p2");
    sc_trace(mVcdFile, zext_ln204_fu_241_p1, "zext_ln204_fu_241_p1");
    sc_trace(mVcdFile, add_ln203_1_fu_261_p2, "add_ln203_1_fu_261_p2");
    sc_trace(mVcdFile, icmp_ln204_fu_245_p2, "icmp_ln204_fu_245_p2");
    sc_trace(mVcdFile, zext_ln203_fu_267_p1, "zext_ln203_fu_267_p1");
    sc_trace(mVcdFile, icmp_ln207_5_fu_291_p2, "icmp_ln207_5_fu_291_p2");
    sc_trace(mVcdFile, icmp_ln207_4_fu_285_p2, "icmp_ln207_4_fu_285_p2");
    sc_trace(mVcdFile, icmp_ln207_3_fu_279_p2, "icmp_ln207_3_fu_279_p2");
    sc_trace(mVcdFile, and_ln207_1_fu_296_p2, "and_ln207_1_fu_296_p2");
    sc_trace(mVcdFile, or_ln207_fu_235_p2, "or_ln207_fu_235_p2");
    sc_trace(mVcdFile, or_ln207_1_fu_302_p2, "or_ln207_1_fu_302_p2");
    sc_trace(mVcdFile, zext_ln203_2_fu_316_p1, "zext_ln203_2_fu_316_p1");
    sc_trace(mVcdFile, icmp_ln214_fu_367_p2, "icmp_ln214_fu_367_p2");
    sc_trace(mVcdFile, add_ln227_fu_397_p2, "add_ln227_fu_397_p2");
    sc_trace(mVcdFile, icmp_ln222_fu_413_p2, "icmp_ln222_fu_413_p2");
    sc_trace(mVcdFile, xor_ln222_fu_418_p2, "xor_ln222_fu_418_p2");
    sc_trace(mVcdFile, and_ln224_fu_424_p2, "and_ln224_fu_424_p2");
...
Loop_Border_proc::~Loop_Border_proc() {
    ...
    delete borderbuf_U;
    delete filter11x11_strm_mul_32ns_32ns_64_3_1_U42;
}
...
void Loop_Border_proc::thread_ap_clk_no_reset_() {
  ...
  esl_seteq<1,2,2>(dst_V_1_state.read(), ap_const_lv2_3))))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln203_fu_250_p2.read()))) {
        i6_0_i_i_i_reg_159 = select_ln203_2_fu_320_p3.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln203_fu_250_p2.read()))) {
        indvar_flatten_reg_148 = add_ln203_fu_255_p2.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        add_ln207_reg_505 = add_ln207_fu_203_p2.read();
        add_ln217_reg_495 = add_ln217_fu_193_p2.read();
        add_ln224_reg_500 = add_ln224_fu_198_p2.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        icmp_ln203_reg_516 = icmp_ln203_fu_250_p2.read();
        icmp_ln203_reg_516_pp0_iter1_reg = icmp_ln203_reg_516.read();
        icmp_ln210_reg_542_pp0_iter1_reg = icmp_ln210_reg_542.read();
        icmp_ln217_reg_546_pp0_iter1_reg = icmp_ln217_reg_546.read();
        icmp_ln224_reg_551_pp0_iter1_reg = icmp_ln224_reg_551.read();
        select_ln203_1_reg_533_pp0_iter1_reg = select_ln203_1_reg_533.read();
        select_ln203_reg_525_pp0_iter1_reg = select_ln203_reg_525.read();
    }
    if (esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0)) {
        icmp_ln203_reg_516_pp0_iter2_reg = icmp_ln203_reg_516_pp0_iter1_reg.read();
        icmp_ln203_reg_516_pp0_iter3_reg = icmp_ln203_reg_516_pp0_iter2_reg.read();
        icmp_ln224_reg_551_pp0_iter2_reg = icmp_ln224_reg_551_pp0_iter1_reg.read();
        select_ln203_reg_525_pp0_iter2_reg = select_ln203_reg_525_pp0_iter1_reg.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln203_fu_250_p2.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, select_ln203_1_fu_308_p3.read()))) {
        icmp_ln210_reg_542 = icmp_ln210_fu_328_p2.read();
        icmp_ln217_reg_546 = icmp_ln217_fu_333_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln203_fu_250_p2.read()))) {
        icmp_ln224_reg_551 = icmp_ln224_fu_338_p2.read();
        select_ln203_1_reg_533 = select_ln203_1_fu_308_p3.read();
        select_ln203_reg_525 = select_ln203_fu_271_p3.read();
    }
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, select_ln203_1_reg_533_pp0_iter1_reg.read()))) {
        pix_out_1_fu_86 = select_ln214_fu_372_p3.read();
        pix_out_fu_82 = l_edge_pix_fu_380_p3.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, select_ln203_1_reg_533.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln210_reg_542.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
...
void Loop_Border_proc::thread_add_ln203_1_fu_261_p2() {
    add_ln203_1_fu_261_p2 = (!i6_0_i_i_i_reg_159.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(i6_0_i_i_i_reg_159.read()) + sc_biguint<11>(ap_const_lv11_1));
}

void Loop_Border_proc::thread_add_ln203_fu_255_p2() {
    add_ln203_fu_255_p2 = (!indvar_flatten_reg_148.read().is_01() || !ap_const_lv64_1.is_01())? sc_lv<64>(): (sc_biguint<64>(indvar_flatten_reg_148.read()) + sc_biguint<64>(ap_const_lv64_1));
}

void Loop_Border_proc::thread_add_ln207_fu_203_p2() {
    add_ln207_fu_203_p2 = (!height_read_reg_474.read().is_01() || !ap_const_lv32_FFFFFFFB.is_01())? sc_lv<32>(): (sc_biguint<32>(height_read_reg_474.read()) + sc_bigint<32>(ap_const_lv32_FFFFFFFB));
}

void Loop_Border_proc::thread_add_ln217_fu_193_p2() {
    add_ln217_fu_193_p2 = (!width_read_reg_466.read().is_01() || !ap_const_lv32_FFFFFFF5.is_01())? sc_lv<32>(): (sc_biguint<32>(width_read_reg_466.read()) + sc_bigint<32>(ap_const_lv32_FFFFFFF5));
}

void Loop_Border_proc::thread_add_ln224_fu_198_p2() {
    add_ln224_fu_198_p2 = (!width_read_reg_466.read().is_01() || !ap_const_lv32_FFFFFFFA.is_01())? sc_lv<32>(): (sc_biguint<32>(width_read_reg_466.read()) + sc_bigint<32>(ap_const_lv32_FFFFFFFA));
}

void Loop_Border_proc::thread_add_ln227_fu_397_p2() {
    add_ln227_fu_397_p2 = (!select_ln203_reg_525_pp0_iter1_reg.read().is_01() || !ap_const_lv11_7FB.is_01())? sc_lv<11>(): (sc_biguint<11>(select_ln203_reg_525_pp0_iter1_reg.read()) + sc_bigint<11>(ap_const_lv11_7FB));
}

void Loop_Border_proc::thread_and_ln207_1_fu_296_p2() {
    and_ln207_1_fu_296_p2 = (icmp_ln207_5_fu_291_p2.read() & icmp_ln207_4_fu_285_p2.read());
}

void Loop_Border_proc::thread_and_ln207_fu_229_p2() {
    and_ln207_fu_229_p2 = (icmp_ln207_2_fu_224_p2.read() & icmp_ln207_1_fu_218_p2.read());
}

void Loop_Border_proc::thread_and_ln224_fu_424_p2() {
    and_ln224_fu_424_p2 = (icmp_ln224_reg_551_pp0_iter2_reg.read() & xor_ln222_fu_418_p2.read());
}
...
void Loop_Border_proc::thread_ap_block_state8_io() {
    ap_block_state8_io = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln203_reg_516_pp0_iter2_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, dst_V_1_ack_in.read()));
}
...
void Loop_Border_proc::thread_ap_block_state9_io() {
    ap_block_state9_io = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln203_reg_516_pp0_iter3_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, dst_V_1_ack_in.read()));
}
...
void Loop_Border_proc::thread_ap_condition_pp0_exit_iter0_state5() {
    if (esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln203_fu_250_p2.read())) {
...
void Loop_Border_proc::thread_ap_predicate_op63_read_state6() {
    ap_predicate_op63_read_state6 = (esl_seteq<1,1,1>(ap_const_lv1_1, select_ln203_1_reg_533.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln210_reg_542.read()));
}
...
void Loop_Border_proc::thread_borderbuf_address0() {
    borderbuf_address0 =  (sc_lv<11>) (zext_ln212_fu_354_p1.read());
}

void Loop_Border_proc::thread_borderbuf_address1() {
    borderbuf_address1 =  (sc_lv<11>) (zext_ln227_fu_402_p1.read());
}
...
void Loop_Border_proc::thread_borderbuf_we0() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_1, select_ln203_1_reg_533_pp0_iter1_reg.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln210_reg_542_pp0_iter1_reg.read()))) {
...
void Loop_Border_proc::thread_dst_V_1_vld_in() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter3.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln203_reg_516_pp0_iter2_reg.read()) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
...
void Loop_Border_proc::thread_dst_V_TDATA_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter3.read()) && 
         ...
         (esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0) && 
          ...
          esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln203_reg_516_pp0_iter3_reg.read())))) {
...
void Loop_Border_proc::thread_icmp_ln203_fu_250_p2() {
    icmp_ln203_fu_250_p2 = (!indvar_flatten_reg_148.read().is_01() || !bound_reg_511.read().is_01())? sc_lv<1>(): sc_lv<1>(indvar_flatten_reg_148.read() == bound_reg_511.read());
}

void Loop_Border_proc::thread_icmp_ln204_fu_245_p2() {
    icmp_ln204_fu_245_p2 = (!zext_ln204_fu_241_p1.read().is_01() || !width_read_reg_466.read().is_01())? sc_lv<1>(): (sc_bigint<32>(zext_ln204_fu_241_p1.read()) < sc_bigint<32>(width_read_reg_466.read()));
}

void Loop_Border_proc::thread_icmp_ln207_1_fu_218_p2() {
    icmp_ln207_1_fu_218_p2 = (!i6_0_i_i_i_reg_159.read().is_01() || !ap_const_lv11_5.is_01())? sc_lv<1>(): (sc_biguint<11>(i6_0_i_i_i_reg_159.read()) > sc_biguint<11>(ap_const_lv11_5));
}

void Loop_Border_proc::thread_icmp_ln207_2_fu_224_p2() {
    icmp_ln207_2_fu_224_p2 = (!zext_ln203_1_fu_208_p1.read().is_01() || !add_ln207_reg_505.read().is_01())? sc_lv<1>(): (sc_bigint<32>(zext_ln203_1_fu_208_p1.read()) < sc_bigint<32>(add_ln207_reg_505.read()));
}

void Loop_Border_proc::thread_icmp_ln207_3_fu_279_p2() {
    icmp_ln207_3_fu_279_p2 = (!add_ln203_1_fu_261_p2.read().is_01() || !ap_const_lv11_0.is_01())? sc_lv<1>(): sc_lv<1>(add_ln203_1_fu_261_p2.read() == ap_const_lv11_0);
}

void Loop_Border_proc::thread_icmp_ln207_4_fu_285_p2() {
    icmp_ln207_4_fu_285_p2 = (!add_ln203_1_fu_261_p2.read().is_01() || !ap_const_lv11_5.is_01())? sc_lv<1>(): (sc_biguint<11>(add_ln203_1_fu_261_p2.read()) > sc_biguint<11>(ap_const_lv11_5));
}

void Loop_Border_proc::thread_icmp_ln207_5_fu_291_p2() {
    icmp_ln207_5_fu_291_p2 = (!zext_ln203_fu_267_p1.read().is_01() || !add_ln207_reg_505.read().is_01())? sc_lv<1>(): (sc_bigint<32>(zext_ln203_fu_267_p1.read()) < sc_bigint<32>(add_ln207_reg_505.read()));
}

void Loop_Border_proc::thread_icmp_ln207_fu_212_p2() {
    icmp_ln207_fu_212_p2 = (!i6_0_i_i_i_reg_159.read().is_01() || !ap_const_lv11_0.is_01())? sc_lv<1>(): sc_lv<1>(i6_0_i_i_i_reg_159.read() == ap_const_lv11_0);
}

void Loop_Border_proc::thread_icmp_ln210_fu_328_p2() {
    icmp_ln210_fu_328_p2 = (!zext_ln203_2_fu_316_p1.read().is_01() || !vconv_xlim_loc_read_reg_480.read().is_01())? sc_lv<1>(): (sc_bigint<32>(zext_ln203_2_fu_316_p1.read()) < sc_bigint<32>(vconv_xlim_loc_read_reg_480.read()));
}

void Loop_Border_proc::thread_icmp_ln214_fu_367_p2() {
    icmp_ln214_fu_367_p2 = (!select_ln203_reg_525_pp0_iter1_reg.read().is_01() || !ap_const_lv11_0.is_01())? sc_lv<1>(): sc_lv<1>(select_ln203_reg_525_pp0_iter1_reg.read() == ap_const_lv11_0);
}

void Loop_Border_proc::thread_icmp_ln217_fu_333_p2() {
    icmp_ln217_fu_333_p2 = (!zext_ln203_2_fu_316_p1.read().is_01() || !add_ln217_reg_495.read().is_01())? sc_lv<1>(): sc_lv<1>(zext_ln203_2_fu_316_p1.read() == add_ln217_reg_495.read());
}

void Loop_Border_proc::thread_icmp_ln222_fu_413_p2() {
    icmp_ln222_fu_413_p2 = (!select_ln203_reg_525_pp0_iter2_reg.read().is_01() || !ap_const_lv11_6.is_01())? sc_lv<1>(): (sc_biguint<11>(select_ln203_reg_525_pp0_iter2_reg.read()) < sc_biguint<11>(ap_const_lv11_6));
}

void Loop_Border_proc::thread_icmp_ln224_fu_338_p2() {
    icmp_ln224_fu_338_p2 = (!zext_ln203_2_fu_316_p1.read().is_01() || !add_ln224_reg_500.read().is_01())? sc_lv<1>(): (sc_bigint<32>(zext_ln203_2_fu_316_p1.read()) < sc_bigint<32>(add_ln224_reg_500.read()));
}

void Loop_Border_proc::thread_j_fu_343_p2() {
    j_fu_343_p2 = (!select_ln203_fu_271_p3.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(select_ln203_fu_271_p3.read()) + sc_biguint<11>(ap_const_lv11_1));
}

void Loop_Border_proc::thread_l_edge_pix_fu_380_p3() {
    l_edge_pix_fu_380_p3 = (!icmp_ln217_reg_546_pp0_iter1_reg.read()[0].is_01())? sc_lv<32>(): ((icmp_ln217_reg_546_pp0_iter1_reg.read()[0].to_bool())? r_edge_pix_fu_78.read(): pix_out_fu_82.read());
}

void Loop_Border_proc::thread_or_ln207_1_fu_302_p2() {
    or_ln207_1_fu_302_p2 = (icmp_ln207_3_fu_279_p2.read() | and_ln207_1_fu_296_p2.read());
}

void Loop_Border_proc::thread_or_ln207_fu_235_p2() {
    or_ln207_fu_235_p2 = (icmp_ln207_fu_212_p2.read() | and_ln207_fu_229_p2.read());
}

void Loop_Border_proc::thread_pix_out_10_fu_437_p3() {
    pix_out_10_fu_437_p3 = (!icmp_ln222_fu_413_p2.read()[0].is_01())? sc_lv<32>(): ((icmp_ln222_fu_413_p2.read()[0].to_bool())? pix_out_1_fu_86.read(): pix_out_8_fu_429_p3.read());
}

void Loop_Border_proc::thread_pix_out_8_fu_429_p3() {
    pix_out_8_fu_429_p3 = (!and_ln224_fu_424_p2.read()[0].is_01())? sc_lv<32>(): ((and_ln224_fu_424_p2.read()[0].to_bool())? borderbuf_q1.read(): pix_out_fu_82.read());
}

void Loop_Border_proc::thread_select_ln203_1_fu_308_p3() {
    select_ln203_1_fu_308_p3 = (!icmp_ln204_fu_245_p2.read()[0].is_01())? sc_lv<1>(): ((icmp_ln204_fu_245_p2.read()[0].to_bool())? or_ln207_fu_235_p2.read(): or_ln207_1_fu_302_p2.read());
}

void Loop_Border_proc::thread_select_ln203_2_fu_320_p3() {
    select_ln203_2_fu_320_p3 = (!icmp_ln204_fu_245_p2.read()[0].is_01())? sc_lv<11>(): ((icmp_ln204_fu_245_p2.read()[0].to_bool())? i6_0_i_i_i_reg_159.read(): add_ln203_1_fu_261_p2.read());
}

void Loop_Border_proc::thread_select_ln203_fu_271_p3() {
    select_ln203_fu_271_p3 = (!icmp_ln204_fu_245_p2.read()[0].is_01())? sc_lv<11>(): ((icmp_ln204_fu_245_p2.read()[0].to_bool())? j_0_i_i_i_reg_170.read(): ap_const_lv11_0);
}

void Loop_Border_proc::thread_select_ln214_fu_372_p3() {
    select_ln214_fu_372_p3 = (!icmp_ln214_fu_367_p2.read()[0].is_01())? sc_lv<32>(): ((icmp_ln214_fu_367_p2.read()[0].to_bool())? r_edge_pix_fu_78.read(): pix_out_1_fu_86.read());
}
...
void Loop_Border_proc::thread_vconv_V_blk_n() {
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_1, select_ln203_1_reg_533.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln210_reg_542.read()))) {
...
void Loop_Border_proc::thread_xor_ln222_fu_418_p2() {
    xor_ln222_fu_418_p2 = (icmp_ln222_fu_413_p2.read() ^ ap_const_lv1_1);
}

void Loop_Border_proc::thread_zext_ln203_1_fu_208_p1() {
    zext_ln203_1_fu_208_p1 = esl_zext<32,11>(i6_0_i_i_i_reg_159.read());
}

void Loop_Border_proc::thread_zext_ln203_2_fu_316_p1() {
    zext_ln203_2_fu_316_p1 = esl_zext<32,11>(select_ln203_fu_271_p3.read());
}

void Loop_Border_proc::thread_zext_ln203_fu_267_p1() {
    zext_ln203_fu_267_p1 = esl_zext<32,11>(add_ln203_1_fu_261_p2.read());
}

void Loop_Border_proc::thread_zext_ln204_fu_241_p1() {
    zext_ln204_fu_241_p1 = esl_zext<32,11>(j_0_i_i_i_reg_170.read());
}

void Loop_Border_proc::thread_zext_ln212_fu_354_p1() {
    zext_ln212_fu_354_p1 = esl_zext<64,11>(select_ln203_reg_525_pp0_iter1_reg.read());
}

void Loop_Border_proc::thread_zext_ln227_fu_402_p1() {
    zext_ln227_fu_402_p1 = esl_zext<64,11>(add_ln227_fu_397_p2.read());
}
...
void Loop_Border_proc::thread_ap_NS_fsm() {
  ...
  esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && 
  esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln203_fu_250_p2.read()) && 
