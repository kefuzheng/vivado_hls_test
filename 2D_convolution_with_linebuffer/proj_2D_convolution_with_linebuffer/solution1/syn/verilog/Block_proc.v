...
reg   [31:0] width_read_reg_69;
reg    ap_block_state1;
reg   [31:0] height_read_reg_75;
reg    ap_block_state2;
reg   [1:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((vconv_xlim_out_out_full_n == 1'b0) | (height_out_full_n == 1'b0) | (width_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (height_empty_n == 1'b0) | (width_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((vconv_xlim_out_out_full_n == 1'b0) | (height_out_full_n == 1'b0) | (width_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (height_empty_n == 1'b0) | (width_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end

always @ (*) begin
    ap_block_state2 = ((vconv_xlim_out_out_full_n == 1'b0) | (height_out_full_n == 1'b0) | (width_out_full_n == 1'b0));
end

assign ap_ready = internal_ap_ready;

assign height_out_din = height_read_reg_75;

assign start_out = real_start;

assign vconv_xlim_out_out_din = ($signed(width_read_reg_69) + $signed(32'd4294967286));

assign width_out_din = width_read_reg_69;
