...
wire    Loop_HConvH_proc8_U0_start_out;
wire    Loop_HConvH_proc8_U0_start_write;
wire    Loop_HConvH_proc8_U0_height_read;
wire    Loop_HConvH_proc8_U0_width_read;
wire    Loop_HConvH_proc8_U0_src_V_TREADY;
wire   [31:0] Loop_HConvH_proc8_U0_hconv_V_din;
wire    Loop_HConvH_proc8_U0_hconv_V_write;
...
reg    ap_sync_reg_Loop_HConvH_proc8_U0_ap_ready;
wire    ap_sync_Loop_HConvH_proc8_U0_ap_ready;
reg   [1:0] Loop_HConvH_proc8_U0_ap_ready_count;
...
#0 ap_sync_reg_Loop_HConvH_proc8_U0_ap_ready = 1'b0;
#0 Loop_HConvH_proc8_U0_ap_ready_count = 2'd0;
end
...
Loop_HConvH_proc8 Loop_HConvH_proc8_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_Loop_HConvH_proc8_U0_ap_ready <= 1'b0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == Loop_HConvH_proc8_U0_ap_ready) & (ap_sync_ready == 1'b1))) begin
        Loop_HConvH_proc8_U0_ap_ready_count <= (Loop_HConvH_proc8_U0_ap_ready_count - 2'd1);
    end else if (((1'b1 == Loop_HConvH_proc8_U0_ap_ready) & (ap_sync_ready == 1'b0))) begin
        Loop_HConvH_proc8_U0_ap_ready_count <= (Loop_HConvH_proc8_U0_ap_ready_count + 2'd1);
    end
end
...
assign Loop_HConvH_proc8_U0_ap_start = ((ap_sync_reg_Loop_HConvH_proc8_U0_ap_ready ^ 1'b1) & ap_start);
...
assign ap_idle = (filter11x11_strm_ent_U0_ap_idle & Loop_VConvH_proc_U0_ap_idle & Loop_HConvH_proc8_U0_ap_idle & Loop_Border_proc_U0_ap_idle & Block_proc_U0_ap_idle);
...
assign ap_sync_Loop_HConvH_proc8_U0_ap_ready = (ap_sync_reg_Loop_HConvH_proc8_U0_ap_ready | Loop_HConvH_proc8_U0_ap_ready);
...
assign ap_sync_ready = (ap_sync_filter11x11_strm_ent_U0_ap_ready & ap_sync_Loop_HConvH_proc8_U0_ap_ready);
...
assign src_V_TREADY = Loop_HConvH_proc8_U0_src_V_TREADY;
